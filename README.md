...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/reg_agenda_search \
  -H 'Content-Type: application/json' \
  -d '{"agency":"EPA","limit":25}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/reg_agenda_search`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
